...
2. Files:
      ...
      l018ll_io50_v1p3_eldo_readme.txt              .... This file!
      l018ll_io50_v1p3_eldo.mdl                     .... Model parameters file for MOSFETs and diode
      l018ll_io50_v1p3_eldo.lib                     .... Corner values for MOSFETs, BJT, resistors and MIM capacitor
      l018ll_io50_v1p3_res_eldo.mdl                 .... Model parameters file for resistors
      l018ll_io50_v1p3_bjt_eldo.mdl                 .... Model parameters file for BJT
      l018ll_io50_v1p3_res_eldo.ckt                 .... Resistors and MIM capacitor macro model
      l018ll_io50_v1p3_mim_eldo.mdl                 .... Model parameters file for MIM capacitor 
...
3. How to use SMIC SPICE models in HSPICE:
      ...
      a. Specify MOS model corner by the '.lib' statement;
         ...
         .lib '/xxx/xxx/l018ll_io50_v1p3_eldo.lib' TT
                                              ^^ mos model corner

      b. Include MOS, diode, resistor, BJT and MIM model parameters by the '.include' statement;
         
         .include '/xxx/xxx/l018ll_io50_v1p3_eldo.mdl'
         
         .include '/xxx/xxx/l018ll_io50_v1p3_res_eldo.mdl'  

         .include '/xxx/xxx/l018ll_io50_v1p3_bjt_eldo.mdl' 

         .include '/xxx/xxx/l018ll_io50_v1p3_mim_eldo.mdl'

      c. Call resistor and MIM macro model subcircuit by the following statement;
         
         .lib '/xxx/xxx/l018ll_io50_v1p3_eldo.lib' TT
                                                   ^^ mos model corner
         .lib '/xxx/xxx/l018ll_io50_v1p3_eldo.lib' RES_TT
                                                       ^^ resistor model corner
         .lib '/xxx/xxx/l018ll_io50_v1p3_eldo.lib' MIM_TT
                                                       ^^ mim model corner
         .include '/xxx/xxx/l018ll_io50_v1p3_res_eldo.ckt'
	 ...
	 subcircuit condition you want to simulate. 
         ...
         Note: For metal resistor, don't need to use the subcircuit file 
               '/xxx/xxx/l018ll_io50_v1p3_res_eldo.ckt'.
