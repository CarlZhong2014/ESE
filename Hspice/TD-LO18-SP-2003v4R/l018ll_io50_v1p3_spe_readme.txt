...
1. Update History:
      ...
      V1.2: a.Revised resistor NPOSAB, NPOSAB_NSTD, PPOSAB, PPOSAB_NSTD sub-circuit model in "ll018ll_io50_v1p2_res_spe.ckt".
            b.Revised "Comparison Between MOSFET Model Simulation and Measurement Results" table in section 7.8.2.
            c.Revised BJT model parameter CJE, CJC in "l018ll_io50_v1p2_bjt_spe.mdl".
            d.Revised BJT corner parameter DCJE, DCJC in "l018ll_io50_v1p2_spe.lib"
...
2. Files:
      ...
      l018ll_io50_v1p3_spe_readme.txt          .... This file!
      l018ll_io50_v1p3_spe.mdl                 .... Model parameters file for MOSFETs and diode
      l018ll_io50_v1p3_spe.lib                 .... Corner values for MOSFETs, BJT, resistors and MIM capacitor
      l018ll_io50_v1p3_res_spe.mdl             .... Model parameters file for resistors
      l018ll_io50_v1p3_bjt_spe.mdl             .... Model parameters file for BJT
      l018ll_io50_v1p3_res_spe.ckt             .... Resistors macro model
      l018ll_io50_v1p3_mim_spe.mdl             .... Model parameters file for MIM capacitor
...
3. How to use SMIC SPICE models in Spectre:
      ...
      a. Specify MOS model corner by the "include" statement;

         include "/xxx/xxx/l018ll_io50_v1p3_spe.lib" section=tt
                                                             ^^ mos model corner

      b. Include MOS, diode, resistor, bjt and MIM model parameters by the "include" statement;
         
         include "/xxx/xxx/l018ll_io50_v1p3_spe.mdl"
         
         include "/xxx/xxx/l018ll_io50_v1p3_res_spe.mdl"  

         include "/xxx/xxx/l018ll_io50_v1p3_bjt_spe.mdl"  

         include "/xxx/xxx/l018ll_io50_v1p3_mim_spe.mdl" 
 
      c. Call resistor macro model subcircuit by the following statement;
         
         include "/xxx/xxx/l018ll_io50_v1p3_spe.lib" section=tt
                                                             ^^ mos model corner
         include "/xxx/xxx/l018ll_io50_v1p3_spe.lib" section=res_tt
                                                                 ^^ resistor model corner
         include "/xxx/xxx/l018ll_io50_v1p3_res_spe.ckt"
	 ...
	 subcircuit condition you want to simulate. 
         ...
         Note: For metal resistor, don't need to use the subcircuit file 
               "/xxx/xxx/l018ll_io50_v1p3_res_spe.ckt".
